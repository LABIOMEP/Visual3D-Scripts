...
- During downsampling, some files may prompt to load a file. This feature is not coded, and its source is unknown. Simply press "Cancel" and the downsampling will resume.
